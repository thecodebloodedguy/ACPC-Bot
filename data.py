gen_questions = [
    "When to apply for ACPC courses or registration?",
    "What is ACPC?",
    "How to register for ACPDC or Diploma courses?",
    "What are the registration charges?",
    "Do I need to register differently for different courses?",
    "What documents are needed to register or create a profile?",
    ...
    "Where can I get a certificate of caste?",
    "Where can I get a certificate of income?",
    "Where can I get a certificate of physically handicapped?",
    "Where can I get a certificate of In-service men?",
    "Where can I get a certificate of ex-service men?",
    ...
    "If I have studied outside Gujarat, can I apply for admission through ACPC for Diploma Pharmacy or Pharmacy?",
    ...
    "For reshuffling, do I need to report at the college?",
    "Do I need to pay the fees for reshuffling at the college?",
    "If I get admission of choice in the mock round, can I secure it?",
    "If an SC or ST or SEBC candidate gets admission under open category, will he be eligible for a scholarship from the govt?",
    ...
    "What is the fee structure of self-financed institutes?",
    ...
    "How to confirm my allotted seat? Candidates can verify the allotment status in the result section."
]

gen_answers = [
    "For Diploma courses, apply after 10th, and for Bachelor's courses apply after 12th, and for Master's courses apply after your Bachelor's degree is completed.",
    "ACPC stands for Admission Committee for Professional Courses. Every year ACPC invites applications for the admission courses. Candidates who are eligible can apply for the available courses from the official website ACPC. The courses you can apply for are engineering, MBC, MCA, Diploma to Degree Engineering, Diploma to Degree Pharmacy, M.Arch, M.Plan, B.Arch, etc.",
    "Please visit https://gujdiploma.admissions.nic.in/ for further information.",
    ...
    "Latest HSC Mark Sheet, Valid NATA-2023 Score card.",
    ...
    "In case of the death of the father, it is valid; else, not valid.",
    ...
    "Reach any Help Centre with the original as well as photocopy of the certificate within the stipulated time limit stipulated by ACPC.",
    ...
    "Candidates can verify their rank by logging in to their module at the NIC website. Also, the same will be reflected in registration details, and candidates can also check the allotted rank on www.acpc-gujarat.gov.in.",
    ...
    "The procedure for admission for NRI or NRI sponsor candidates is the same as mentioned on the ACPC website.",
    ...
    "Yes.",
    "Yes.",
    "Candidates can verify allotment status in the result section."
]



be_questions = [
    "When will the admission process for Degree Engineering or B.Tech or BE or BE or BTech start?",
    ...
    "What are or is the registration charges or price",
    "What documents are or do I need or require or necessary for Degree Engineering?",
    "If I have appeared or given in JEE(Main) and GUJCET both, can I apply in both together?",
    "If I have studied outside Gujarat, can I apply for admission through ACPC for Degree Engineering or BE or B.E.?",
    "What are the necessary or required or needed criteria for eligibility for admission through ACPC for Degree Engineering or BE or B.E. course?",
    "How are merit marks calculated or counted for Degree Engineering or BE or B.E. admissions?",
    "What is the procedure or process or method for admission for NRI or NRI sponsor candidate?",
    "What is the process or procedure or method for applying in Management Quota or MQ?",
    "If I opt for management quota or MQ admission, am I still eligible for regular quota?",
    "If I get admission in management quota or MQ can I go for reshuffling?"
]

be_answers = [
    "The process of registration for Degree Engineering is expected to start at the end of June.",
    "The examination of CBSE, ICSE, JEE(Main), and GUJCET is pending, but students can register prior to the same.",
    ...
    "The registration charges are 350.",
    "Latest HSC mark sheet, GUJCET score card, JEE(Main) NEET scorecard.",
    ...
    "The merit marks are calculated as the sum of sixty percentage of the percentile obtained in the theory subjects Physics, Chemistry, and Mathematics and forty percentage weightage of the percentile obtained in the GUJCET.",
    "Follow guidelines by ACPC on www.jacpcldce.ac.in.",
    "As per the guidelines given by ACPC available on website www.jacpcldce.ac.in.",
    "Yes, you are still eligible for regular quota.",
    "Yes, you can go for reshuffling if you get admission in management quota or MQ."
]
...
pred_questions=[
    "If I have scored 90 which college will I get for Computer or Computer Engineering or CE or CSE or Computer or Computer Science Engineering?","If my merit marks are 98.234 which college will I get for CSE or Computer Science or CE or Computer Engineering or Computer?","If my rank or ACPC rank is 1200 which college will I get for CE or CSE or COmpter Engineering or Computer Science or Computer Science Engineering?",
    ...
    "what will be the cutoff or necessary or needed or required rank for EEE VGEC or Vishwakarma Enginerring College for EWS category?","what will be the cutoff or required or needed or necessary rank for CSE or CE or Computer Engineering DDIT for EVS category?","what will be the cutoff or necessary or needed or required rank for Civil Enginerring LDCE or LD College or LD Engineering for TFW category?","what will be the cutoff or required or needed or necessary merit marks for Mechanical Engineering or ME LJ or LJ College or LJ Engineering for ST category?","what will be the cutoff or required or needed or necessary merit marks for Electrical Engineering or EE DDIT for SEBC category?",
    "what will be the cutoff or required or needed or necessary merit marks for EEE VGEC or Vishwakarma Enginerring College for EWS category?","what will be the cutoff or required or necessary or needed merit marks for CSE or CE or Computer Engineering DDIT for EVS category?","what will be the cutoff or required or necessary or needed merit marks for Civil Enginerring LDCE or LD College or LD Engineering for TFW category?","Colleges or List of colleges for Computer Science or Computer Engineering or CE or CSE in AHmedabad for ST Category",
    "Colleges or List of colleges for Electrical Engineering or EE in AHmedabad for ST Category","Colleges or List of colleges for Automobile Engineering in Baroda for SEBC Category",
    "Colleges or List of colleges for ICT or Information and Communication Technology in AHmedabad for TWS Category","Colleges or List of colleges for Computer Science or Computer Engineering or CE or CSE in Mehsana for EVS Category",
    "Colleges or List of colleges for Chemical Engineering in Ahmedabad for EWSC Category","Colleges or List of colleges for IT or Information Technology or IT Engineering in AHmedabad for Open Category"
]
...
intents_list=[
    ...
    },
    {
        ...
        "responses": [
            "I apologise for that","I am sorry I was not helpful to you"
        ]
    },
      {
        "tag": "how_are_you",
        "patterns": ["How are you?", "How are you doing?"],
        "responses": ["I'm good, thank you!", "Feeling great! How about you?"]
      },
      {
        "tag": "noanswer",
        "patterns": ["!","@","#","$"],
    ...
    },
    {
    ...
    },
      {
        ...
        "responses": [
          "I will help you with your admission queries.",
          "I help solve admission queries.",
          "I can provide information and answer questions related to admissions.",
          "I am capable of assisting with queries about educational admissions."
        ]
      },
      {
        "tag": "who_created_you",
        ...
        "responses": [
          "I was created by Government of Gujarat.",
          "I was developed at KCG."
        ]
      },
      {
        "tag":"name",
        "patterns":["What is your name","What can I call you"],
        "responses":["I am yet to be named","I don't have a name"]
      },
      {
        "tag": "default",
        "patterns": ["see ya!", "bye", "goodbye","take care!"],
...
sentences_A = [ "What is the procedure or process or requirements for M. Pharm Admission?",
    "Which are the websites to apply of M. Pharm courses?",
    "How is the Merit list prepared or made?",
    "Do I need to verify my documents in person offline?",
    "What is the eligibility or necessary criteria or criteria or for M. Pharm admission?",
...
sentences_B = ["If I have scored 90 which college will I get for Computer or Computer Engineering or CE or CSE or Computer or Computer Science Engineering?","If my merit marks are 98.234 which college will I get for CSE or Computer Science or CE or Computer Engineering or Computer?","If my rank or ACPC rank is 1200 which college will I get for CE or CSE or COmpter Engineering or Computer Science or Computer Science Engineering?",
    "What is or was the closure rank or rank of LDCE or LD Engineering college or LD college for CE or CSE or Computer Engineering or Computer Science or Computer Science Engineering or Computer?","Will I get LJ College Electrical or EE if my rank is 12000?","Will I get LD or LDCE or LD College ECE or Electronics and Communication or EC Engineering if my merit marks is or are 65?",
    "Will I get LD or LDCE or LD College Mechanical or Mechanical Engineering or ME if my merit marks is or are 73.54627?","What is or was the merit closure for DDIT for Civil Engineering?","What are the merit marks required or necessary or needed for DDIT Mechanical or Mechanial Engineering?","Colleges or List of colleges for Computer Science or Computer Engineering or CE or CSE in AHmedabad","Colleges in Baroda for EE or ELectrical ENgineering or Electrical","Colleges for ME or Mechanical Engineering under rank 12000",
    "Colleges for ME or Mechanical Engineering under 69 marks or merit marks","Colleges for ME or Mechanical Engineering under 88.3882 marks or merit marks",
    "Colleges for Civil Engineering with or having clousre rank 15000","Colleegs for IT or Information technology Engineering in Ahmedabad under or cutoff rank 1200","Colleges for IT or Information technology Engineering in Ahmedabad under or cutoff merit marks or marks 55",
...
sentences_C = ["Hi", "Hello", "Hey""Whats up",
            "Wazzup",
            "sup",
            "how old are you","when were you made","what is your age","it was nice talking to you",
            "good talk","you are useless","useless","suggest","suggestions","you are bad","How are you?", "How are you doing?","!","@","#","$","Tell me a joke",
            "Joke",
            "Make me laugh","Tell me a joke",
            "Joke",
            "Make me laugh","Who created you?",
          "Who wrote your code?",
          "Who developed you?",
          "Who is your owner?","What is your name","What can I call you","see ya!", "bye", "goodbye","take care!"]
